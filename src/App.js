    ...
    <div className="App">
      ...
      <main className="App-main">
        ...
        <section className="Contact" id="contact">
          <h2>Contact</h2>
          <p>Email: vivekvardhanboreddy@gmail.com</p>
          <p>LinkedIn: <a href="https://www.linkedin.com/in/vivek-vardhan-reddy-3a843124b/">Your LinkedIn Profile</a></p>
          <p>Github: <a href="https://github.com/Vivekvardhanreddy1707">Your GitHub Profile</a></p>
        </section>
      </main>
    </div>
  );
